...
<body>
  ...
  <div id="content">
         ...
         <h2 style="display: inline;">CANTIDAD DE INSUMOS DE LA CLINICA</h2>
                <p class="text-center">Cantidad de placas tipo 6 1/2:{{$placas6}}</p>
                <p class="text-center">Cantidad de placas tipo 8 x 10:{{$placas8}}</p>
                <p class="text-center">Cantidad de placas tipo 10 x 12:{{$placas10}}</p>
                <p class="text-center">Cantidad de placas tipo 11 x 14:{{$placas11}}</p>
                <p class="text-center">Cantidad de placas tipo 14 x 14:{{$placas14}}</p>
                <p class="text-center">Cantidad de placas tipo 14 x 17:{{$placas17}}</p>
                <p class="text-center">Cantidad de placas tipo Set Revelador:{{$setRevelador}}</p>
                <p class="text-center">Cantidad de placas tipo Set Fijador:{{$setFijador}}</p>
