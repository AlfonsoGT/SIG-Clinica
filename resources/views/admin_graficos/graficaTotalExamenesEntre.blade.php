...
<html>
  ...
  <td>Generar Gráficos entre los Años:
     <input id="A1" type="text"  size="20" name="A1" value="año menor del rango" onfocus= value="" autocomplete="off" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
    Y <input id="A2" type="text" size="20" name="A2" value="año mayor del rango" onfocus= value="" autocomplete="off" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
